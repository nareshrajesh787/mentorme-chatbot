...
const serviceCards = [
  {
    ...
    body: "Ask about One-to-One Mentoring, Mentoring After School, MM Connect Clubs, and how to enroll a child.",
  },
  {
    number: "02",
    title: "Become a mentor",
    body: "Find official guidance on volunteer requirements, background checks, and the application process.",
  },
  {
    number: "03",
    title: "Get involved",
    body: "Learn where to begin with donations, events, and other ways to support MentorMe.",
  },
] as const;
  ...
  return (
    <main className="demo-page">
      <header className="demo-header">
        <a href="#top" className="demo-brand" aria-label="MentorMe assistant prototype home">
          <MentorMeLogo className="demo-place-logo" priority />
        ...
        <nav aria-label="Prototype navigation">
          ...
          >
            Contact MentorMe <ArrowIcon size={16} />
          </a>
        </nav>
      </header>
      ...
      <section className="hero" id="top">
        <div className="hero-text">
          ...
          <p className="hero-lede">
            The MentorMe Information Assistant helps visitors navigate approved
            program, volunteer, and enrollment information with official
            sources attached to every supported answer.
          </p>
          ...
          <div className="trust-line">
            <ShieldIcon />
            <span>
              Answers come only from approved information from MentorMe.
            </span>
          </div>
        </div>
          ...
          <div className="hero-card">
            <div className="hero-card-top">
              <span className="hero-card-brand">
                <MentorMeLogo className="hero-card-logo" decorative />
              </span>
      ...
      <footer className="demo-footer">
        <div className="footer-place-brand">
          <span className="footer-place-logo-wrap">
            <MentorMeLogo className="footer-place-logo" />
          </span>
