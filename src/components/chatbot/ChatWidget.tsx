      ...
      {showLauncher ? (
        <>
          {nudgeVisible ? (
            <div className="chat-launcher-nudge" role="status">
              <button
                ...
                onClick={openPanel}
                aria-label="Need help? Open MentorMe chatbot"
              >
                ...
                <span>
                  ...
                  <small>Ask the MentorMe chatbot</small>
                </span>
              </button>
              <button
                type="button"
          ...
          <button
            ...
            onClick={openPanel}
            aria-label="Open MentorMe assistant"
            aria-expanded={open}
          >
            <span className="launcher-logo-wrap" aria-hidden="true">
              <MentorMeLogo className="launcher-place-logo" decorative />
            </span>
            <span>Ask MentorMe</span>
          </button>
        </>
      ) : null}
    </div>
